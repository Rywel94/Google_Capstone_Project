...
I've found out that their is only 9 True values presnt in the adult column, this information will not give us anything significant, so that column is also dropped.
